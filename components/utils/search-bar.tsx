...
function SearchBar({search}: SearchBarProps) {
  return (
    <form action="/search" method="get" className="flex flex-wrap justify-center items-center mx-auto py-4">
      <div className="w-full relative text-3xl text-gray-600">
        {search}
      </div>
      <div className="relative w-full md:w-1/2 lg:1/3">
        ...
        <input type="search" id="search" name="search" className="block p-4 pl-10 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:outline-none" placeholder="Search"></input>
